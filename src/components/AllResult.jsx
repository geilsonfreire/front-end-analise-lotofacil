    ...
    return (
        <section className="w-full">
            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div className="border-b border-violet-100 bg-gradient-to-r from-violet-950 to-fuchsia-700 px-5 py-4">
                    ...
                    <div className="max-h-[60vh] overflow-auto p-3">
                        <table className="w-full min-w-[650px] border-separate border-spacing-0 text-sm">
                            <thead className="sticky top-0 z-10">
                                <tr><th className="rounded-t-xl bg-slate-50 px-3 py-2" colSpan="5"><div className="flex justify-end gap-2">
